        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="{{ route('kontak') }}" :active="request()->is('kontak')">Contact</x-nav-link>
                ...
                @auth
                    <el-dropdown class="relative ml-3">
                        <button class="flex items-center">
                            <img  src="https://en.gundam.info/about-gundam/series-pages/gquuuuuux/glh/jp/character/2025/05/chara_03_01.png"
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img
              src="https://en.gundam.info/about-gundam/series-pages/gquuuuuux/glh/jp/character/2025/05/chara_03_01.png"
              alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Muhammad Febrian</div>
            <div class="text-sm font-medium text-gray-400">febianfebian323@gmail.com</div>
          </div>
          <button type="button"
