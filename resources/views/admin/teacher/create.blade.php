        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('admin.teacher.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" data-modal-hide="addTeacherModal"
                        class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">Cancel</button>
                    <button type="submit"
                        class="px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800">Save</button>
                </div>
            </form>
        </div>
    </div>
